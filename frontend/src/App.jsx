            ...
            >
              <span className="whatsAppIcon" aria-hidden="true">
                <svg viewBox="0 0 32 32" focusable="false" aria-hidden="true">
                  <path d="M16 3.2a12.8 12.8 0 0 0-10.9 19.6L3 29l6.4-2.1A12.8 12.8 0 1 0 16 3.2zm0 23.4c-2 0-3.9-.5-5.5-1.5l-.4-.2-3.8 1.3 1.2-3.7-.2-.4a10.6 10.6 0 1 1 8.7 4.5zm5.8-7.9c-.3-.2-1.8-.9-2.1-1-.3-.1-.5-.2-.8.2l-.6.8c-.2.2-.4.2-.7.1-1.8-.9-3-2.5-3.2-2.8-.2-.3 0-.4.1-.6l.5-.6c.2-.2.2-.4.3-.6.1-.2 0-.4 0-.6l-.9-2.2c-.2-.5-.4-.4-.6-.4h-.6c-.2 0-.6.1-.9.4-.3.3-1.1 1.1-1.1 2.6 0 1.6 1.2 3.1 1.3 3.3.2.2 2.2 3.4 5.3 4.6.8.3 1.4.5 1.9.6.8.3 1.5.2 2.1.1.6-.1 1.8-.8 2.1-1.5.3-.7.3-1.3.2-1.4z" />
                </svg>
              </span>
